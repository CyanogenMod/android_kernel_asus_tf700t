...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  2, 1, MHZ,   1,   1, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1250, 1300, 1330, 1400, 1550, 1600),
	CPU_DVFS("cpu_g",  2, 2, MHZ,   1,   1, 700, 700,  860,  860, 1050, 1150, 1200, 1280, 1300, 1350, 1400, 1400, 1550, 1600),
	CPU_DVFS("cpu_g",  2, 3, MHZ,   1,   1, 770, 770,  910,  910, 1150, 1230, 1280, 1300, 1350, 1400, 1400, 1400, 1550, 1600),

	CPU_DVFS("cpu_g",  3, 1, MHZ,   1,   1, 1, 1,  780,  780,  990, 1040, 1100, 1200, 1250, 1300, 1330, 1400, 1550, 1600),
	CPU_DVFS("cpu_g",  3, 2, MHZ,   1,   1, 1, 1,  860,  860, 1050, 1150, 1200, 1280, 1300, 1350, 1400, 1400, 1550, 1600),
	CPU_DVFS("cpu_g",  3, 3, MHZ,   1,   1, 1, 1,  910,  910, 1150, 1230, 1280, 1300, 1350, 1400, 1400,1400, 1550, 1600),
	...
	CPU_DVFS("cpu_g",  7, 0, MHZ,   1,   1, 550, 550,  680,  680,  820,  970, 1040, 1080, 1150, 1200, 1280, 1300,1450,1500),
	CPU_DVFS("cpu_g",  7, 1, MHZ,   1,   1, 650, 650,  780,  780,  990, 1040, 1100, 1200, 1300, 1300,1300, 1300,1450,1500),
	CPU_DVFS("cpu_g",  7, 2, MHZ,   1,   1, 700, 700,  860,  860, 1050, 1150, 1200, 1300, 1300, 1300,1300, 1300,1450,1500),
	CPU_DVFS("cpu_g",  7, 3, MHZ,   1,   1, 770, 770,  910,  910, 1150, 1230, 1300, 1300, 1300, 1300,1300, 1300,1450,1500),
	CPU_DVFS("cpu_g",  7, 4, MHZ,   1,   1, 770, 770,  940,  940, 1160, 1300, 1300, 1300, 1300, 1300,1300, 1300,1450,1500),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  520000),

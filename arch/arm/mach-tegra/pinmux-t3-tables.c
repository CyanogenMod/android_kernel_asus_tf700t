...
static __initdata struct tegra_pingroup_config cardhu_pcbid_pinmux[] = {
	...
	//PCB_ID3
	DEFAULT_PINMUX(KB_COL7, KBC, PULL_DOWN, TRISTATE, INPUT),
	//PCB_ID4
	DEFAULT_PINMUX(KB_ROW2, KBC, PULL_DOWN, TRISTATE, INPUT),
	//PCB_ID5
	DEFAULT_PINMUX(KB_COL5, KBC, PULL_DOWN, TRISTATE, INPUT),
	//PCB_ID6
